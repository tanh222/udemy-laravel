...
<div class="container mt-2">
    <div class="row mt-3 mb-3 ">
        <div class="col-sm">
            <div>
                <p class="h2 text-center text-uppercase text-drak">THÊM SẢN PHẨM</p>
                <form method="POST" action="{{route('createCustom')}}">
                    @csrf
                    <div class="mb-3 mt-3">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" class="form-control" placeholder="Nhập mô tả" name="describe" >
                    </div>
                    <div class="mb-3 mt-3">
